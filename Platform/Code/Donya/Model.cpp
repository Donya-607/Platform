...
#include "Direct3DUtil.h"	// Use for create some buffers.
#include "Donya.h"			// Use GetDevice().
#include "Resource.h"		// Use for create a texture.
#include "Useful.h"			// Use convert string functions.
