...
namespace Donya
{
	...
	namespace Font
	{
		...
		public:
			void Draw( const wchar_t *string,		const Donya::Vector2 &ssPosLeftTop, const Donya::Vector4 &blendColor = { 1.0f, 1.0f, 1.0f, 1.0f } ) const;
			void Draw( const std::wstring &string,	const Donya::Vector2 &ssPosLeftTop, const Donya::Vector4 &blendColor = { 1.0f, 1.0f, 1.0f, 1.0f } ) const;
		};
	}
}
