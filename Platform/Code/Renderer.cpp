...
void RenderingHelper::VoxelizeConstant::ShowImGuiNode( const char *nodeCaption )
{
	...
	ImGui::DragFloat	( u8"É{ÉNÉZÉãÉTÉCÉY",	&voxelSize,		0.001f );
	ImGui::SliderFloat	( u8"Åhí[ÅhÇÃïù",		&edgeSize,		0.0f, 1.0f );
	ImGui::SliderFloat	( u8"Åhí[ÅhÇÃñæÇÈÇ≥",	&edgeDarkness,	0.0f, 1.0f );
